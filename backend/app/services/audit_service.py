...
class AuditAction:
    ...
    # item 8 -- the milestone's own explicitly-named additional events
    # ("Finding risk rating changed", "Finding linked/unlinked to
    # action"), plus the new manual ARCHIVED lifecycle terminus.
    ...
    RISK_ASSESSMENT_CONTROL_CREATED = "RISK_ASSESSMENT_CONTROL_CREATED"
    RISK_ASSESSMENT_CONTROL_UPDATED = "RISK_ASSESSMENT_CONTROL_UPDATED"
