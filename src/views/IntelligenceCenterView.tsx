        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-[11px] font-mono px-2 py-0.5 rounded-full bg-blue-600/10 text-blue-300 border border-blue-500/20">
              6 Active Predictive Reasoning Models
            </span>
          </div>
              ...
              {filteredRisks.map((risk) => (
                ...
                >
                  <div>
                    ...
                    {/* Prob & Confidence Metrics */}
                    <div className="grid grid-cols-2 gap-3 my-4 p-3 rounded-lg bg-[#09090B] border border-white/5">
                      <div>
                        ...
                        <span className="text-[10px] text-slate-500 font-mono">Next 30-Day Exposure</span>
                      </div>
                      <div>
                        <span className="text-[10px] text-slate-400 uppercase tracking-wider block">
                          Model Confidence
                        ...
                        <span className="text-[10px] text-slate-500 font-mono">Cross-Validated Net</span>
                      </div>
                    </div>
                    ...
                    <div className="space-y-1.5 mb-4">
                      ...
                      {risk.drivers.slice(0, 4).map((drv, idx) => (
                    ...
                    {/* Evidence Badges */}
                    <div className="flex items-center gap-3 text-xs text-slate-400 pb-4 border-b border-white/5">
                      <span className="flex items-center gap-1 font-mono text-blue-300">
                        <FileText className="w-3.5 h-3.5 text-blue-400" />
                        <span>{risk.orgRecordsCount} org records</span>
                      </span>
                      <span>•</span>
                      <span className="flex items-center gap-1 font-mono text-purple-300">
                        <Sparkles className="w-3.5 h-3.5 text-purple-400" />
                        <span>{risk.externalSourcesCount} external sources</span>
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between pt-4 gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        onClick={() => onOpenEvidence(risk.organizationEvidence[0])}
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-[11px] text-slate-400">
                Filtered prediction models sorted by Bayesian posterior probability
              </p>
            </div>
            <div className="text-xs font-mono text-blue-400">
              {filteredRisks.length} Predictions in Scope
            </div>
          </div>
            ...
            <table className="w-full text-left text-xs border-collapse">
              <thead>
                <tr className="border-b border-white/5 text-slate-500 font-semibold uppercase tracking-wider text-[10px]">
                  ...
                  <th className="py-2.5 px-3 text-right">Detailed Analysis</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-white/5 text-slate-300">
                {filteredRisks.map((risk) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-3 text-slate-400 text-[11px]">
                      {risk.forecastPeriod || 'Next 30 Days'}
                    </td>
